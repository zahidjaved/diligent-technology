        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                <div class="card">
                    ...
                    <h3>The Brilliant People</h3>
                    <p>Only the best of the best become our hires. Some polished personalities who get things done.</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                <div class="card">
                    ...
                    <p>Going solo or working with others, we have professional individuals with a drive to achieve big.
                    </p>
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                <div class="card">
                    ...
                    <h3>The Flexible Workforce</h3>
                    <p>At any given moment, you can reach our cooperative staff. Be it from the far end of the globe.
                    </p>
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                <div class="card">
                    ...
                    <h3>The Timeless Service</h3>
                    <p>With a timezone-friendly work style, we do not let long distances disrupt the tasks at hand.</p>
                </div>
            </div>
        </div>
    </div>
