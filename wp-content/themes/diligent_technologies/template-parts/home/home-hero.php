            ...
            <div class=" col-lg-7 ">
                <div class="hero-text">
                    ...
                    <div class="hero-cta-btns">
                        <a class="hero-cta-btn" href="">Reach out </a>
                        <a class="hero-cta-icon" href="">Hire Us Now <span class="btn-svg"><svg
                        ...
                        <div class="hero-news-letter-form">
                            <form action="">
                                ...
                                <div class="charter-form-btn">
                                    <input type="submit" value="Start Your Project" class="submit_btn" />
                                </div>
                            </form>
                        </div>
                    </div>
